...
namespace App\Models {
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<DepartmentManager>|DepartmentManager whereDeptId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<DepartmentManager>|DepartmentManager whereEmployeeId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<DepartmentManager>|DepartmentManager whereIsPrimary($value)
     * @method static \Illuminate\Database\Eloquent\Builder<DepartmentManager>|DepartmentManager whereStartDate($value)
     * @method static \Illuminate\Database\Eloquent\Builder<DepartmentManager>|DepartmentManager whereEndDate($value)
     * @method static \Illuminate\Database\Eloquent\Builder<DepartmentManager>|DepartmentManager whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<DepartmentManager>|DepartmentManager whereUpdatedAt($value)
     ...
     * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Models\UserGroup> $groups
    ...
    /**
     * App\Models\GroupMembershipPivot
     *
     * @property-read \Illuminate\Database\Eloquent\Collection<int, \Spatie\Permission\Models\Role> $roles
     * @property-read int|null $roles_count
     * @property-read \Illuminate\Database\Eloquent\Collection<int, \Spatie\Permission\Models\Permission> $permissions
     * @property-read int|null $permissions_count
     * @method static \Illuminate\Database\Eloquent\Builder<GroupMembershipPivot>|GroupMembershipPivot role()
     * @method static \Illuminate\Database\Eloquent\Builder<GroupMembershipPivot>|GroupMembershipPivot withoutRole()
     * @method static \Illuminate\Database\Eloquent\Builder<GroupMembershipPivot>|GroupMembershipPivot permission()
     * @method static \Illuminate\Database\Eloquent\Builder<GroupMembershipPivot>|GroupMembershipPivot withoutPermission()
     * @method static \Illuminate\Database\Eloquent\Builder<GroupMembershipPivot>|GroupMembershipPivot newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<GroupMembershipPivot>|GroupMembershipPivot newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<GroupMembershipPivot>|GroupMembershipPivot query()
     * @method static mixed select($columns)
     * @method static mixed selectSub($query, $as)
     * @method static mixed selectRaw($expression, array $bindings)
     * @method static mixed fromSub($query, $as)
     ...
     * @mixin \Illuminate\Database\Query\Builder
     */
    class GroupMembershipPivot extends \Illuminate\Database\Eloquent\Relations\Pivot
    {
        //
    }
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<UserGroup>|UserGroup whereGroupName($value)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<UserGroup>|UserGroup role()
     * @method static \Illuminate\Database\Eloquent\Builder<UserGroup>|UserGroup withoutRole()
     * @method static \Illuminate\Database\Eloquent\Builder<UserGroup>|UserGroup permission()
     * @method static \Illuminate\Database\Eloquent\Builder<UserGroup>|UserGroup withoutPermission()
